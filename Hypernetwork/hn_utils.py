...
def HypernetInterpolation(net_A, net_B,
                alpha = 0.5):
    ...
    # TODO in case they are not the same
...
def Hypernet_plot_1d(hypernet_A, hypernet_B, model_frame,
    ...
    for alpha in tqdm(alpha_list, desc = "1d plot: "):
        model_int = HypernetInterpolation(hypernet_A, hypernet_B, alpha)
...
def Subspace_plot_1d(hypernet_A, hypernet_B, model_frame,
    ...
    for alpha in tqdm(alpha_list, desc = "Subspace 1d plot: "):
        subparams_C = SubspaceInterpolation(hypernet_A, hypernet_B, alpha)
